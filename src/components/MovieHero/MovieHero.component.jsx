    ...
    return (
        <>
            <div>
              ...
              <div className=" absolute w-64 h-96 z-30 left-24 top-10 ">
                  <img src="https://in.bmscdn.com/iedb/movies/images/extra/vertical_logo/mobile/thumbnail/xxlarge/zack-snyder-s-justice-league-et00047164-10-04-2021-03-22-49.jpg" alt="Poster" className="h-full w-full rounded-xl"/>
              </div>   
