...
import {BiChevronRight, BiChevronDown, BiSearchAlt2, BiMenu,BiShareAlt} from 'react-icons/bi';
            ...
            <div className="container mx-auto px-4 flex  justify-between">
                <div className="flex items-center gap-3 w-1/2">
                    <div className="w-12 h-12">
                        <img src="https://i.ibb.co/zPBYW3H/imgbin-bookmyshow-office-android-ticket-png.png" alt="brand__img" 
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <button className="bg-red-600 text-white px-3 py-2 text-sm rounded w-full">Sign In</button>
