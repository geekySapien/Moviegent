        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="bg-premiere-800 py-12 ">
                <div className="container mx-auto px-4 flex flex-col gap-3" >
                    ...
                    <PosterSlider images={popularMovies} title="Premiere" subtitle="Brand New Releases Every Friday" isDark="true"/>
                </div>
            </div> 
            <div className="container mx-auto px-4 " > 
                <PosterSlider images={topRated} title="Online Streaming Events" subtitle=""/>
            </div>
             <div className="container mx-auto px-4 " > 
